                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm" data-toggle="modal"
                                            data-target="#modalEditarCategoria{{ $value->id }}">
                                            <i class="fas fa-edit"></i>
                                        </button>

                                        <form action="{{ route('categorias.eliminar') }}" method="POST" class="d-inline">
                                            @csrf
                                            ...
                                            <form action="{{ route('categorias.editar') }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Nombre</label>
                                                        <input type="text" name="editarCategoria" class="form-control"
