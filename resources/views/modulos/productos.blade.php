...
ControladorProductos::ctrEliminarProducto();
            ...
            <?php foreach ($productos as $key => $value): ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="index.php?ruta=productos&idProducto=<?= $value["id"] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar producto?')">
